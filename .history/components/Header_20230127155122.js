...
const links = [{
    ...
    label: 'Ingenieros/ Emprendedores',
    route: '/about'
},{
    label: 'Tienda',
    route: '/tienda'
...
export default function Navigation () {
    ...
    return (
        <>
            <nav id="scrollspyh" 
                className={"navbar navbar-light bg-light navbar-expand-lg fixed-top"} data-spy="affix" data-offset-top="20">
